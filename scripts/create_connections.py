...
f = open("C:/Users/lsalie/Desktop/UCT/NIS/Assignment/data/intratracerouteresults.json", "r")
lines = f.readlines()
f.close()
...
f = open("C:/Users/lsalie/Desktop/UCT/NIS/Assignment/data/nodesintra.csv", 'w')
f.write(allnodes)
f.close()
...
c = "All"
f = open("C:/Users/lsalie/Desktop/UCT/NIS/Assignment/data/linksintra" + c + ".csv", 'w')
